...
def create_proposal_docx(output_path):
    ...
    techs = [
        ...
        ("Core Engineering Stack: ", "Go (Golang) for high-concurrency orchestrator routines, PostgreSQL 16 & MinIO for metadata and S3 object storage, and Next.js 14 / TypeScript for operator UI.")
    ]
    ...
    bens = [
        ...
        ("Zero-Trust Edge Cryptographic Integrity: ", "Delivers an empirically validated, zero-trust verification framework capable of executing on industrial edge controllers with minimal latency overhead, confirming real-time viability without disrupting motor motion-control loops."),
